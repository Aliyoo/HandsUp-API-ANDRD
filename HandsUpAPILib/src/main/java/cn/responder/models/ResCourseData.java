...
public class ResCourseData 
    ...
    private static final long serialVersionUID = 4804980367913613698L;
    private String courseId;
    private String courseName;
    private String courseTchName;
    private List<CourseTimeEnum> courseTime;
    /** GETTER
     * 课程ID
     */
    @JsonGetter("courseId")
    ...
    public List<CourseTimeEnum> getCourseTime ( ) { 
    ...
    public void setCourseTime (List<CourseTimeEnum> value) { 
