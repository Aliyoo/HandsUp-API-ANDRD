...
public class LoginorEnrollController extends BaseController {    
    ...
    public void getEnrollAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5470462715785283853L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5255045226700983005L;
            {
    ...
    public void getLoginAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5036917220385558912L;
            {
                    put( "userNumber", userNumber );
                    put( "userPassword", userPassword );
                    put( "userRole", userRole );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5270327664443148157L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
