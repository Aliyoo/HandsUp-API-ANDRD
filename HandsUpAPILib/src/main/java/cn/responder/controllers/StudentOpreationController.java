...
public class StudentOpreationController extends BaseController {    
    ...
    public void getQueryCourseAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5460133759897243368L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4874664455028399632L;
            {
    ...
    public void getSeletedCourseAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5221680305880741260L;
            {
                    put( "stuId", stuId );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5368882097067793097L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void getCancelSelectedCourseAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5519544024609971338L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5492978469534068617L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void getSelectCourseAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5033224071722363709L;
            {
                    put( "courseId", courseId );
                    put( "stuId", stuId );
                    put( "stuNumber", stuNumber );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5070904408678790475L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void getToAnswerAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5054192564904468584L;
            {
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5739334264852164384L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
